                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <h1 class="h4 text-gray-900 mb-4">Edit Data Kelas</h1>
                            </div>
                            <form class="user" action="proses_edit_kelas.php" method="POST">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="id_kelas" value="<?php echo $result['id_kelas'];?>" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nama_kelas" value="<?php echo $result['nama_kelas'];?>">
                                </div>
                                <div class="form-group">
