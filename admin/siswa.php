...
<head>
    ...
    <title>SPP Admin - Table Siswa</title>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_siswa.php?nisn=<?php echo $data['nisn'];?>"><button class="btn btn-warning">Edit</button></a>
                                                <button class="btn btn-danger" onclick="konfirmasiHapus('hapus_siswa.php?nisn=<?php echo $data['nisn'];?>', 'siswa <?php echo $data['nama'];?>')">Hapus</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                                <a href="tambah_data_siswa.php"><button class="btn btn-primary">Tambah Data</button></a>
                            </div>
                        </div>
                    </div>
