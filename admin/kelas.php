...
<head>
    ...
    <title>SPP Admin - Table Kelas</title>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_kelas.php?id_kelas=<?php echo $data['id_kelas'];?>"><button class="btn btn-warning">Edit</button></a>
                                                <button class="btn btn-danger" onclick="konfirmasiHapus('hapus_kelas.php?id_kelas=<?php echo $data['id_kelas'];?>', 'kelas <?php echo $data['nama_kelas'];?>')">Hapus</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                                <a href="tambah_data_kelas.php"><button class="btn btn-primary">Tambah Data</button></a>
                            </div>
                        </div>
                    </div>
