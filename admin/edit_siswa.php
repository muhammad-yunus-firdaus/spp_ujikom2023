                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" action="proses_edit_siswa.php" method="POST">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nisn" value="<?php echo $result['nisn'];?>" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nis" value="<?php echo $result['nis'];?>">
                                </div>
                                <div class="form-group">
