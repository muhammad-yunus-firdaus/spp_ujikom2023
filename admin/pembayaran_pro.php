                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="form-signin" style="margin-top: 20px;" action="proses_pembayaran.php" method="post" name="barcode-form">
  
                              <label for="inputPassword" class="sr-only">Nisn</label>
                              <input type="text" id="nisn" name="nisn" class="form-control" onchange="isi_otomatis()" autocomplete="off" placeholder="NISN" required autofocus><br/>
                              ...
                              <label for="inputPassword" class="sr-only">Tahun</label>
                              <input type="text" id="tahun" name="tahun" class="form-control" autocomplete="off" placeholder="Tahun" readonly><br/>
                              
                              <label for="inputPassword" class="sr-only">Nominal</label>
                              <input type="text" id="nominal" name="nominal" class="form-control" autocomplete="off" placeholder="nominal" readonly><br/>
