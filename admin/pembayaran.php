...
<body id="page-top">
    <?php
        if (isset($_GET['pesan'])) {
            if ($_GET['pesan'] == "gagal_spp") {?>
                <script>
                    alert("Pembayaran Gagal, Siswa tidak berada ditahun tersebut");
                </script>
            <?php }elseif ($_GET['pesan'] == "gagal_bulan") {?>
                 <script>
                    alert("Pembayaran Gagal, Siswa sudah membayar pada bulan tersebut");
                </script>
            <?php }
        }
    ?>
